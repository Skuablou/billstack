...
export default function YearlyProjection({ subscriptions }: Props) {
  ...
  return (
    <div
      ...
      style={{ background: isLight ? "linear-gradient(135deg, hsl(210 70% 90%), hsl(220 60% 84%))" : "linear-gradient(135deg, hsl(220 65% 22%), hsl(230 50% 16%))", borderColor: isLight ? "hsl(210 60% 58%)" : "hsl(210 65% 38%)", borderWidth: "2px", boxShadow: isLight ? "0 4px 20px -6px hsl(210 70% 60% / 0.3)" : "0 0 30px -10px hsl(210 80% 55% / 0.2)" }}
    >
